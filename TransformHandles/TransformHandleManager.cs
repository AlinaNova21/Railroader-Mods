...
namespace TransformHandles
{
    public class TransformHandleManager : Singleton<TransformHandleManager>
    {
        ...
        [Header("Shortcuts")]
        [SerializeField] public KeyCode positionShortcut = KeyCode.W;
        [SerializeField] public KeyCode rotationShortcut = KeyCode.E;
        [SerializeField] public KeyCode scaleShortcut = KeyCode.R;
        [SerializeField] public KeyCode allShortcut = KeyCode.A;
        [SerializeField] public KeyCode spaceShortcut = KeyCode.X;
        [SerializeField] public KeyCode pivotShortcut = KeyCode.Z;
    ...
    public class TransformGroup
    {
        ...
        {
            foreach (var pair in RenderersMap)
            {
                var tElement = pair.Key;
                var meshRenderer = pair.Value;
